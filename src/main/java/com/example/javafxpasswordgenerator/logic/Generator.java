...
public class Generator {
    ...
    private BooleanProperty removeSimilarFlagProperty;
    ...
    // Password Length
    private IntegerProperty passwordLengthProperty;

    // Final CharSet for password
    private ArrayList<Integer> finalSet;
